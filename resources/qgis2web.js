...
map.getView().fit([2812234.460501, -561855.524999, 3716366.665049, -103927.949762], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte sud-kivu</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (87 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Une carte intéractive de la province du Sud-kivu se trouvant en République Démocratique';
            }
